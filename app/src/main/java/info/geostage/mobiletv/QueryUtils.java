...
public final class QueryUtils {
    ...
    private static List<Movies> extractFeatureFromJson(String moviesJSON) {
        ...
        try {
            ...
            // Extract the JSONArray associated with the key called "categories",
            // which represents a list of movies).
            JSONArray categories = baseJsonResponse.getJSONArray("categories");
            ...
            // For each movie in the moviesArray, create an {@link Movies} object
            for (int i = 0; i < categories.length(); i++) {

                // Get a single category at position i within the list of categories
                currentMovies = categories.getJSONObject(i);
                ...
                // Check if key "category_name" exists and if yes, return value

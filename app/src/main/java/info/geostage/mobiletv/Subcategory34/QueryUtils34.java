package info.geostage.mobiletv.Subcategory34;
...
public final class QueryUtils34 {
    ...
    private static final String KEY_SUBCAT = "subcategories";
     ...
     */
    private static final String LOG_TAG = QueryUtils34.class.getSimpleName();

    /**
     * Create a private constructor because no one should ever create a {@link QueryUtils34} object.
     * This class is only meant to hold static variables and methods, which can be accessed
     * directly from the class name QueryUtils (and an object instance of QueryUtils is not needed).
     */
    private QueryUtils34() {
    }
    ...
    private static List<Movies33> extractFeatureFromJson(String moviesJSON) {
        ...
        try {
            ...
            for (int i = 0; i < subcategories.length(); i++) {
                ...
                // Check if key "subcategories" exists and if yes, return value
                if (currentMovies.has(KEY_SUBCAT)) {
                    subcat = currentMovies.getString(KEY_SUBCAT);
                } else {
                    subcat = null;
                }

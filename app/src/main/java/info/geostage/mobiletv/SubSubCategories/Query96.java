...
public final class Query96 {
     ...
     */
    private static final String LOG_TAG = Query96.class.getSimpleName();

    /**
     * Create a private constructor because no one should ever create a {@link Query96} object.

...
public final class Query91 {
     ...
     */
    private static final String LOG_TAG = Query91.class.getSimpleName();

    /**
     * Create a private constructor because no one should ever create a {@link Query91} object.

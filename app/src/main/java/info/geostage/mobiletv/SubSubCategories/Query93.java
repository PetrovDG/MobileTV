...
public final class Query93 {
     ...
     */
    private static final String LOG_TAG = Query93.class.getSimpleName();

    /**
     * Create a private constructor because no one should ever create a {@link Query93} object.

...
public final class Query83 {
     ...
     */
    private static final String LOG_TAG = Query83.class.getSimpleName();

    /**
     * Create a private constructor because no one should ever create a {@link Query83} object.

...
public final class Query89 {
     ...
     */
    private static final String LOG_TAG = Query89.class.getSimpleName();

    /**
     * Create a private constructor because no one should ever create a {@link Query89} object.

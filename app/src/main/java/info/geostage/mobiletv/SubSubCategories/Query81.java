...
public final class Query81 {
     ...
     */
    private static final String LOG_TAG = Query81.class.getSimpleName();

    /**
     * Create a private constructor because no one should ever create a {@link Query81} object.

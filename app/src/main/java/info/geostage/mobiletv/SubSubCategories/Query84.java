...
public final class Query84 {
     ...
     */
    private static final String LOG_TAG = Query84.class.getSimpleName();

    /**
     * Create a private constructor because no one should ever create a {@link Query84} object.

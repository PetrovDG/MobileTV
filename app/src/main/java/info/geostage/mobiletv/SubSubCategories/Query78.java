...
public final class Query78 {
     ...
     */
    private static final String LOG_TAG = Query78.class.getSimpleName();

    /**
     * Create a private constructor because no one should ever create a {@link Query78} object.

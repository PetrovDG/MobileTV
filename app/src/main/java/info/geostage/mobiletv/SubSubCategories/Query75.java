...
public final class Query75 {
     ...
     */
    private static final String LOG_TAG = Query75.class.getSimpleName();

    /**
     * Create a private constructor because no one should ever create a {@link Query75} object.

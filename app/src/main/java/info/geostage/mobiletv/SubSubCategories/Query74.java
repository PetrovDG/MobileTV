...
public final class Query74 {
     ...
     */
    private static final String LOG_TAG = Query99.class.getSimpleName();

    /**
     * Create a private constructor because no one should ever create a {@link Query74} object.

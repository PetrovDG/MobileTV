...
public final class Query85 {
     ...
     */
    private static final String LOG_TAG = Query85.class.getSimpleName();

    /**
     * Create a private constructor because no one should ever create a {@link Query85} object.

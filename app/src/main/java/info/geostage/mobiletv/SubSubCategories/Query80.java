...
public final class Query80 {
     ...
     */
    private static final String LOG_TAG = Query80.class.getSimpleName();

    /**
     * Create a private constructor because no one should ever create a {@link Query80} object.

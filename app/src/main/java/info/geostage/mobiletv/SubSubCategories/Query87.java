...
public final class Query87 {
     ...
     */
    private static final String LOG_TAG = Query87.class.getSimpleName();

    /**
     * Create a private constructor because no one should ever create a {@link Query87} object.

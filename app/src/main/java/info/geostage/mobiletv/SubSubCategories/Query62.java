...
public final class Query62 {
     ...
     */
    private static final String LOG_TAG = Query62.class.getSimpleName();

    /**
     * Create a private constructor because no one should ever create a {@link Query62} object.

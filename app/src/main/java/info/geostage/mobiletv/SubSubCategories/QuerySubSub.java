...
public final class QuerySubSub {
     ...
     */
    private static final String LOG_TAG = QuerySubSub.class.getSimpleName();

    /**
     * Create a private constructor because no one should ever create a {@link QuerySubSub} object.

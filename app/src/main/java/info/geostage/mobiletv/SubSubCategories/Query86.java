...
public final class Query86 {
     ...
     */
    private static final String LOG_TAG = Query86.class.getSimpleName();

    /**
     * Create a private constructor because no one should ever create a {@link Query86} object.

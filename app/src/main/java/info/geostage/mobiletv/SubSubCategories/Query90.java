...
public final class Query90 {
     ...
     */
    private static final String LOG_TAG = Query90.class.getSimpleName();

    /**
     * Create a private constructor because no one should ever create a {@link Query90} object.
